...
- **Vehicle Status API**
  ...
  ![Code quality](https://sonarcloud.io/api/project_badges/measure?project=com.alten.vehicle.monitoring%3Avehicle-status-management&metric=alert_status 'Code Quality') ![Code Coverage](https://sonarcloud.io/api/project_badges/measure?project=com.alten.vehicle.monitoring%3Avehicle-status-management&metric=coverage 'Code Coverage') ![Code Coverage](https://sonarcloud.io/api/project_badges/measure?project=com.alten.vehicle.monitoring%3Avehicle-status-management&metric=sqale_rating 'Code Coverage') ![Loc](https://sonarcloud.io/api/project_badges/measure?project=com.alten.vehicle.monitoring%3Avehicle-status-management&metric=ncloc 'Lines of Code') ![Code duplication](https://sonarcloud.io/api/project_badges/measure?project=com.alten.vehicle.monitoring%3Avehicle-status-management&metric=duplicated_lines_density) ![Vul](https://sonarcloud.io/api/project_badges/measure?project=com.alten.vehicle.monitoring%3Avehicle-status-management&metric=vulnerabilities)
